...
/**
 * Template Name: Scientific Paper Presentation
 */
get_header();
?>
...
<main class="min-h-screen">
        ...
        <div class="px-4 sm:px-6 py-2 md:px-10 lg:px-12 xl:px-16">
            <div class="breadcrumbs text-sm">
                <ul class="flex justify-start">
                    ...
                    <li class="text-blue"> Scientific Paper Presentation</li>
                </ul>
            </div>
        </div>
    </section>

    <!-- <section class="px-4 sm:px-6 py-8 md:p-10 lg:p-12 xl:p-16 bg-white border-t border-b border-[#DDE4F3]">
        <div class="text-2xl md:text-3xl text-blue font-semibold text-center mb-10 uppercase">
            Scientific Paper Presentation
        </div>

        <div class="grid min-[360px]:grid-cols-2 md:grid-cols-3  lg:grid-cols-5 gap-y-6 gap-x-3 sm:gap-x-5 lg:gap-10">
            <div class=" flex flex-col gap-2">
                ...
                <div class="text-center space-y-2 grow">
                    <div class="text-red font-medium text-sm lg:text-md">
                        Dr. V. Balagopala Raju
                    </div>
                    <div class="text-dark text-sm">Award</div>

                </div>

                <div class="flex justify-center items-center">
                    <a href="<?php echo esc_url(wp_upload_dir()['baseurl']); ?>/2025/06/Scientific-Paper.pdf" download class="flex justify-center items-center w-fit gap-2 bg-[#FEC02F] rounded-md text-black px-4 py-2 text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3" viewBox="0 0 25 26" fill="none">
                            ...
                            <path d="M11.2584 0V14.2372L7.22393 10.2028L5.32324 12.1034L11.6529 18.4331C11.9051 18.6849 12.2469 18.8264 12.6032 18.8264C12.9596 18.8264 13.3014 18.6849 13.5536 18.4331L19.8832 12.1034L17.9826 10.2028L13.9481 14.2372V0H11.2584Z" fill="black" />
                        </svg><span>
                            Download Now
                        </span></a>
                </div>
            ...
            <div class=" flex flex-col gap-2">
                ...
                <div class="text-center space-y-2 grow">
                    <div class="text-red font-medium text-sm lg:text-md">
                        Dr. B. R. Santhanakrishnan
                    </div>
                    <div class="text-dark text-sm">Award - Teaching &
                        Non-Teaching Institution</div>
    ...
    <section class="px-4 sm:px-6 py-8 md:p-10 lg:p-12 xl:p-16 bg-white border-t border-b border-[#DDE4F3]">
        ...
        <div class="grid min-[360px]:grid-cols-2 md:grid-cols-3  lg:grid-cols-5 gap-y-6 gap-x-3 sm:gap-x-5 lg:gap-10">
            <?php if (have_rows('scientific_paper_presentations')) : ?>
                <?php while (have_rows('scientific_paper_presentations')) : the_row();
                    $name = get_sub_field('name');
                    $award = get_sub_field('award');
                    $pdf = get_sub_field('pdf_file');
                    $image = get_sub_field('image'); // optional
                ?>
                    <div class="flex flex-col gap-2">
                        <div>
                            <div class="aspect-square rounded-lg flex justify-center items-center overflow-hidden">
                                <?php if ($image): ?>
                                    <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt'] ?: $name); ?>" class="object-cover w-full h-full rounded-lg" />
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <?php if ($pdf): ?>
                            <div class="flex justify-center items-center">
                                <a href="<?php echo esc_url($pdf); ?>" download class="flex justify-center items-center w-fit gap-2 bg-[#FEC02F] rounded-md text-black px-4 py-2 text-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3" viewBox="0 0 25 26" fill="none">
                                        <path d="M0.5 22.8621C0.5 23.6943 0.830603 24.4924 1.41908 25.0809C2.00756 25.6694 2.8057 26 3.63793 26H21.569C22.4012 26 23.1993 25.6694 23.7878 25.0809C24.3763 24.4924 24.7069 23.6943 24.7069 22.8621V17.931H22.0172V22.8621C22.0172 22.981 21.97 23.095 21.8859 23.179C21.8019 23.2631 21.6879 23.3103 21.569 23.3103H3.63793C3.51904 23.3103 3.40502 23.2631 3.32095 23.179C3.23688 23.095 3.18966 22.981 3.18966 22.8621V17.931H0.5V22.8621Z" fill="black" />
                                        <path d="M11.2584 0V14.2372L7.22393 10.2028L5.32324 12.1034L11.6529 18.4331C11.9051 18.6849 12.2469 18.8264 12.6032 18.8264C12.9596 18.8264 13.3014 18.6849 13.5536 18.4331L19.8832 12.1034L17.9826 10.2028L13.9481 14.2372V0H11.2584Z" fill="black" />
                                    </svg>
    ...
    <!-- <section class="px-4 sm:px-6 py-8 md:p-10 lg:p-12 xl:p-16">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <div class=" flex flex-col  rounded-lg overflow-hidden">
                ...
                <div class="bg-gray-200 h-72 w-full">

                </div>

                <div class="flex justify-between items-center gap-4 bg-white p-4 border-l border-b border-r border-[#DDE4F3] rounded-b-lg">
    ...
    <section class="px-4 sm:px-6 py-8 md:p-10 lg:p-12 xl:p-16 !pt-0">
        <div class="mb-10">
            <div class="text-2xl md:text-3xl text-blue font-semibold text-center mb-2 uppercase">
                Days of Presentation
            </div>
            <div class="text-sm text-center">(Can be modified to suit the conference programme)</div>
        </div>

        <div class="grid min-[360px]:grid-cols-2 md:grid-cols-3  lg:grid-cols-5 gap-y-6 gap-x-3 sm:gap-x-5 lg:gap-10">
            <?php if (have_rows('days_of_presentation')) : ?>
                <?php while (have_rows('days_of_presentation')) : the_row();
                    $name = get_sub_field('name');
                    $award = get_sub_field('award');
                    $image = get_sub_field('image'); // optional
                ?>
        ...
        <!-- <div class="grid min-[360px]:grid-cols-2 md:grid-cols-3  lg:grid-cols-5 gap-y-6 gap-x-3 sm:gap-x-5 lg:gap-10">
            <div class=" flex flex-col gap-2">
                ...
                <div class="text-center space-y-2 grow">
                    ...
                    <div class="text-dark text-sm">Award - Day 2</div>
            ...
            <div class=" flex flex-col gap-2">
                ...
                <div class="text-center space-y-2 grow">
                    ...
                    <div class="text-dark text-sm">Award - Day 3</div>
            ...
            <div class=" flex flex-col gap-2">
                ...
                <div class="text-center space-y-2 grow">
                    ...
                    <div class="text-dark text-sm">Award - Teaching &
                        Non Teaching Institution - Day 3</div>
